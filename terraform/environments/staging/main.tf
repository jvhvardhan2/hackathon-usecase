terraform {
  ...
  backend "gcs" {
    bucket = "healthcare-tfstate-staging-YOUR_PROJECT_ID"
...
module "vpc" {
  ...
  private_subnet_cidr_1 = "10.10.10.0/24"
  private_subnet_cidr_2 = "10.10.11.0/24"
  pods_cidr_1           = "10.11.0.0/16"
  pods_cidr_2           = "10.12.0.0/16"
  services_cidr_1       = "10.13.0.0/16"
  services_cidr_2       = "10.14.0.0/16"
}
